# DAN-Government SSO — Frontend

**eID-д суурилсан үндэсний нэгдсэн нэвтрэлт (Single Sign-On)** –ийн Next.js 15
frontend. Backend нь Go (chi · pgx · PostgreSQL · Redis) — энэ frontend түүн рүү
**BFF (Backend-for-Frontend)** загвараар прокси хийнэ. Underlying stack нь
*Government Template Platform V3.0* (Clean-Architecture Go backend + Next.js BFF +
Gemini AI).
