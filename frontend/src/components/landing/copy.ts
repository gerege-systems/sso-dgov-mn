...
const mn: LandingCopy = {
  ...
  hero: {
    ...
    titleTail: 'үйлчилгээ',
    lede:
      'Төрийн нэгдсэн нэвтрэлт нь үндэсний цахим үнэмлэх (eID)-т тулгуурласан төрийн нэгдсэн нэвтрэлт юм. Нэг удаа баталгаажуулснаар холбогдсон бүх төрийн болон хувийн үйлчилгээнд дахин нэвтрэлгүйгээр, найдвартай орно.',
    ctaLogin: 'eID-ээр нэвтрэх',
    ctaExplore: 'Боломжийг үзэх',
    stackLabel: 'Дэмждэг стандартууд',
    stats: [
      { value: 'eID', label: 'Цахим үнэмлэхээр баталгаажна' },
  ...
  advantages: {
    ...
    eidBody:
      'Гар утасны цахим үнэмлэхийн апп руу шууд мэдэгдэл илгээх, эсвэл QR код уншуулан хормын дотор нэвтэрнэ. Нэг утсан дээр ч, компьютер-утас хослуулан ч ажиллана. Нэг ч нууц үг цээжлэх шаардлагагүй.',
  ...
  tech: {
    ...
    trustBadge: 'ИДЭВХТЭЙ',
    trustItems: [
      'Цахим үнэмлэхээр баталгаажуулалт',
  ...
  cta: {
    ...
    sub: 'Цахим үнэмлэхээ бэлдээд, нэг л баталгаажуулалтаар холбогдсон бүх үйлчилгээнд аюулгүй нэвтэрнэ.',
    ctaLogin: 'eID-ээр нэвтрэх',
    ctaExplore: 'Боломжийг үзэх',
    tagline: 'Цахим үнэмлэх · Нээлттэй стандарт · Найдвартай хамгаалалт',
  },
  footer: {
    tagline: 'Үндэсний цахим үнэмлэхэд суурилсан төрийн нэгдсэн нэвтрэлт. Gerege Systems, 2026.',
