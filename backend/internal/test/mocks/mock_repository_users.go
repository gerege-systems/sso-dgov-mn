...
// UpsertSuperAdmin provides a mock function with given fields: ctx, in
func (_m *UserRepository) UpsertSuperAdmin(ctx context.Context, in *domain.User) (domain.User, error) {
	ret := _m.Called(ctx, in)
